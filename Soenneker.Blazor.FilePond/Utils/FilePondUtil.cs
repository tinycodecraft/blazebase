...
internal static class FilePondUtil
{
        ...
        string localBasePath = "_content/Soenneker.Blazor.FilePond/css/")
    {
        ...
        var cdnLinks = new Dictionary<string, (string uri, string integrity)>
        {
            ...
            {
                nameof(FilePondPluginType.GetFile),
                ("https://cdn.jsdelivr.net/npm/@tofandel/filepond-plugin-get-file@1.1.0/dist/filepond-plugin-get-file.min.css",
                    "sha256-gM/wwTFakinb43JzUNDe+/065qSihhec2k7xEcH7UxA=")
            }
        ...
        string localBasePath = "_content/Soenneker.Blazor.FilePond/js/")
    {
        if (type == null)
        {
            return useCdn
                ...
                : ($"{localBasePath}filepond-adj.debug.js?v=3", null);
        }
        ...
        var cdnLinks = new Dictionary<string, (string uri, string integrity)>
        {
            ...
            {
                nameof(FilePondPluginType.GetFile),
                ("https://cdn.jsdelivr.net/npm/@tofandel/filepond-plugin-get-file@1.1.0/dist/filepond-plugin-get-file.min.js",
                    "sha256-PgSYV6Bnf28ub49qnlQrMcah126Owa0kfp4Cb7OJABA=")
            },
