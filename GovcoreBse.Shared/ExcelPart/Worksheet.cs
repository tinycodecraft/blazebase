...
namespace GovcoreBse.Shared.ExcelPart
{
    ...
    public class Worksheet
    {
        ...
        /// </summary>
        public List<Row> GetPopulateRowsFromDataTable(DataTable table, int existingHeadingRows = 0)
        {
        ...
        /// Populate rows from datatable
        /// </summary>
        public void PopulateRowsFromDataTable(DataTable table, int existingHeadingRows = 0,bool withheading=true)
        {
            var rowNumber = existingHeadingRows + 1;
